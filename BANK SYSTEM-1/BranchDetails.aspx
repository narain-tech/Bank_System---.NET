...
<body>
    ...
    <table class="style2">
        ...
        <tr>
            <td class="style4">
                <asp:TextBox ID="PinCodeTextBox" runat="server"></asp:TextBox>
            </td>
            <td>
                <asp:Button ID="FindButton" runat="server" onclick="FindButton_Click" 
                    Text="Find" />
            </td>
            <td>
                Branch Name:</td>
        ...
        <tr>
            <td class="style3">
                (Please Entre your Zip Code\City or District)</td>
            <td>
                &nbsp;</td>
            <td>
                Branch Manager:</td>
